  ...
  return (
    <section id="diferencial" className="py-24 bg-slate-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div>
            ...
            <div className="space-y-4">
              {PROBLEMS_SOLVED.map((problem, idx) => (
                <div key={idx} className="flex items-center gap-4 bg-slate-800/50 p-4 rounded-lg border-l-4 border-red-500">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {VALUES.map((value, idx) => (
                <div key={idx} className="bg-slate-800 p-6 rounded-xl border border-slate-700 hover:border-brand-500 transition-colors">
        ...
        {/* Big Statement */}
        <div className="text-center bg-gradient-to-r from-brand-900 to-slate-900 p-10 md:p-16 rounded-3xl border border-slate-700 shadow-2xl">
